            ...
            {activeModal === "events" && (
              <div className="text-center py-4 animate-fade-in">
                ...
                <div className="grid grid-cols-2 gap-4 max-h-[350px] overflow-y-auto p-1">
                  {["Spring Calligraphy Expo", "Duanwu Festival Gala", "Detroit Civic Performance", "Dragon Boat Folk Gala"].map((title, i) => (
                    <div key={i} className="border border-outline/10 p-3 bg-white/50 rounded-2xl hover:scale-[1.03] transition-transform">
            ...
            {activeModal === "team" && (
              <div className="animate-fade-in">
                ...
                <div className="space-y-4 max-h-[380px] overflow-y-auto pr-1">
                  {[
                    { initials: "LY", name: "L. Yan, Founder & Chairman", bio: "Dedicated local administrator with over a decade of Chinese school experience. Visionary who pivoted rote learning toward service and dynamic storytelling." },
                    { initials: "WH", name: "W. Huang, Educational Director", bio: "Educational scholar focusing on cultural adaptation and curriculum building. Designs our calligraphy, arts, and conversation modules." },
                    { initials: "XL", name: "X. Li, Performing Arts Coordinator", bio: "Accomplished musician and stage performance director. Oversees instruments, orchestra collaborations, and community folk performances." }
                  ].map((member, i) => (
                    <div key={i} className="p-4 border rounded-2xl bg-white/50 flex flex-col md:flex-row gap-4 items-center">
                      ...
                      <div>
                        <h4 className="font-headline text-base font-bold text-primary">{member.name}</h4>
                        <p className="font-body text-xs text-on-surface-variant leading-relaxed">{member.bio}</p>
                      </div>
                    </div>
                  ))}
                </div>
