...
export default function AboutPage({ onBack = () => { window.location.href = '/'; } }: AboutPageProps) {
    ...
    <div className="pt-32 pb-24 min-h-screen bg-about animate-fade-in relative select-text">
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-[1280px] relative z-10">
        ...
        <div ref={containerRef} className="text-center max-w-4xl mx-auto mb-20">
          <span className="text-primary font-body text-xs font-bold uppercase tracking-widest block mb-4">Our Mission</span>
        ...
        <div className="space-y-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h3 className="font-headline text-2xl md:text-3xl text-primary font-bold">Cultivating Cultural Identity</h3>
            ...
            <div className="overflow-hidden rounded-3xl shadow-xl border-4 border-white/50 transform hover:scale-[1.02] transition-transform duration-500">
              <img alt="Cultivating Identity" className="w-full h-[400px] object-cover" loading="lazy" src={IMAGES.founding_story_left} />
            </div>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="lg:order-2 space-y-6">
              <h3 className="font-headline text-2xl md:text-3xl text-primary font-bold">Community at the Core</h3>
              <p className="font-body text-base text-on-surface-variant leading-relaxed">
            ...
            <div className="lg:order-1 overflow-hidden rounded-3xl shadow-xl border-4 border-white/50 transform hover:scale-[1.02] transition-transform duration-500">
              <img alt="Advocacy and Service" className="w-full h-[400px] object-cover" loading="lazy" src={IMAGES.community_engagement} />
            </div>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h3 className="font-headline text-2xl md:text-3xl text-primary font-bold">Where Tradition Meets Now</h3>
              <p className="font-body text-base text-on-surface-variant leading-relaxed">
            ...
            <div className="overflow-hidden rounded-3xl shadow-xl border-4 border-white/50 transform hover:scale-[1.02] transition-transform duration-500">
              <img alt="Intersection of Art" className="w-full h-[400px] object-cover" loading="lazy" src={IMAGES.cultural_performance} />
            </div>
          </div>
        </div>
