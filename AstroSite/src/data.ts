...
export const PARTNERS: PartnerItem[] = [
  { name: "Eastern Market", img: easternMarketImg },
  { name: "Michigan Chinese Women's Association", img: michiganWomenImg },
  { name: "Oakland Chinese Church", img: oaklandChurchImg },
  { name: "Association of Chinese Americans", img: acaLogoImg },
  { name: "Metro Detroit Chinese Alliance Church", img: mdcacLogoImg },
  { name: "Auburn Hills Public Library", img: auburnHillsEventImg },
];
