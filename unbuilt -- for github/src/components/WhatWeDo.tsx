          ...
          <div className="lg:w-1/2 w-full scroll-reveal-left">
            <div className="relative w-full h-[520px]">
              <img
                ...
                className="absolute top-0 left-0 w-full h-[340px] rounded-3xl shadow-xl object-cover z-10 border border-white/20 hover:scale-[1.01] transition-transform duration-500"
                referrerPolicy="no-referrer"
                src={IMAGES.team_performance}
              />
              <div className="absolute bottom-0 right-0 w-2/3 h-52 bg-white/90 p-2.5 rounded-3xl shadow-2xl z-20 border border-white/40 overflow-hidden transform hover:scale-[1.02] transition-transform duration-500">
                <img
                  alt="Cello player"
