...
export default function Hero() {
  return (
    <section className="bg-hero relative min-h-[100vh] flex items-center justify-center pt-32 overflow-hidden pb-20">
      ...
      <div className="relative z-10 container mx-auto px-margin-mobile md:px-margin-desktop text-center max-w-5xl">
        ...
        <div className="liquid-glass-strong rounded-3xl p-8 md:p-16 max-w-4xl mx-auto transform transition-all hover:scale-[1.01] duration-500">
