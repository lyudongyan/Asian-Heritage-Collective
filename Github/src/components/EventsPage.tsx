...
const PAST_EVENTS_LIST: EventItem[] = [
  {
    ...
    images: [IMAGES.oakland_church, IMAGES.open_house_event]
  },
  {
    id: "evt-2",
        ...
        <div className="pt-32 pb-24 min-h-screen bg-about animate-fade-in relative select-text">
          <div className="container mx-auto px-margin-mobile md:px-margin-desktop max-w-4xl">
            ...
            <article className="liquid-glass-strong rounded-3xl p-6 md:p-10 border border-primary/5 shadow-sm space-y-8 text-left">
              ...
              {/* Main Cover Image */}
              <div className="w-full h-64 md:h-[450px] overflow-hidden rounded-2xl border border-white/50 shadow-inner">
                <img
                  alt={evt.title}
              ...
              {/* Event Gallery */}
              {evt.images.length > 0 && (
                <div className="space-y-4 border-t border-primary/10 pt-8 mt-8">
              ...
              {/* Navigation buttons */}
              <div className="border-t border-primary/10 pt-8 mt-12 flex items-center justify-between gap-4">
                {eventIndex > 0 ? (
                  <button
